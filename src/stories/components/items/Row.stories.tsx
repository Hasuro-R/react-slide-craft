    ...
    children: (
      <>
        <div style={{ padding: '15px', backgroundColor: '#fff3e0', flex: 2, margin: '5px' }}>
          <BodyText text="メインコンテンツ（2倍幅）" size="base" />
        </div>
        <div style={{ padding: '15px', backgroundColor: '#f1f8e9', flex: 1, margin: '5px' }}>
          <BodyText text="サイドバー" size="base" />
        </div>
      </>
    ),
  },
